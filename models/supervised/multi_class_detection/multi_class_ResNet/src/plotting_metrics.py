...
def plot_training_metrics(metrics, df):
    ...
    plt.suptitle('Training Metrics Over Epochs, 34 Layer Res-Net for Five Classes', fontsize=16)

    # plt.suptitle('Training Metrics Over Epochs, 34 Layer Res-Net', fontsize=16)
