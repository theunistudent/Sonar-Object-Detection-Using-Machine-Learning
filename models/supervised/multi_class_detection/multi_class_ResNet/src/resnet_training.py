...
from resnet_data import SonarImages, SonarVideo, CombinedSonarDataset
from resnet_model import ResNetModel
from plotting_metrics import plot_training_metrics, plot_confusion_matrix_values

# Initialize configparser
config = configparser.ConfigParser()
config.read('/mnt/sda2/liam/SONAR_thesis/models/supervised/multi_class_detection/multi_class_ResNet/src/config.ini')
...
model = ResNetModel(1080, 1920, class_list).to(device=device)
