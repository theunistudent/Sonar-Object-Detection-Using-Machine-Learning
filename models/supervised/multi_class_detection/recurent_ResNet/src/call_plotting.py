...
import os
sys.path.append(os.path.abspath("/mnt/sda2/liam/SONAR_thesis/models/supervised/multi_class_detection/recurent_ResNet/src"))

# from models.supervised.multi_class_detection.lstm_ResNet.src.lstm_metrics import plot_training_metrics
from recurrent_metrics import plot_training_metrics
