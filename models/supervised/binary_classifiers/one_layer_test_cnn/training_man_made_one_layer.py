...
from one_layer_model import ManMade                                                                                         # Name change
...
relative_checkpoint_dir = "models/supervised/one_layer_cnn/checkpoints"                                                     # Name change
relative_historic_checkpoint_dir = "models/supervised/one_layer_cnn/checkpoints/historic_checkpoints"                       # Name change
metrics_location = f"{relative_checkpoint_dir}/training_metrics.csv"
relative_checkpoint_path = os.path.join(relative_checkpoint_dir, "one_layer_cnn_checkpoint.tar")                            # Name change  
